		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#productsinventoryproductsinventory-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"productsinventoryproductsinventory-display": {
								"semanticObject": "productsinventoryproductsinventory",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=products.inventory.productsinventory",
									"url": sap.ui.require.toUrl("products/inventory/productsinventory")
								}
							}
						}
					}
